        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ChoiceId = table.Column<short>(type: "smallint", nullable: false),
                    BeatsChoiceId = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerChoiceId = table.Column<short>(type: "smallint", nullable: false),
                    ComputerChoiceId = table.Column<short>(type: "smallint", nullable: false),
                    ChoiceId = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<string>(type: "character varying(96)", maxLength: 96, nullable: true),
                    Active = table.Column<bool>(type: "boolean", nullable: false),
                    Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(96)", maxLength: 96, nullable: false),
                    LastModified = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChoicesHistory_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChoicesHistory_Choice_ChoiceId",
                        column: x => x.ChoiceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChoicesHistory_ChoiceId",
                table: "ChoicesHistory",
                column: "ChoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ChoicesHistory_UserId",
                table: "ChoicesHistory",
                column: "UserId");
